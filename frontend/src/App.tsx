...
import { LuncIncineratorClient } from './contract/clients/LuncIncineratorClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new LuncIncineratorClient(lcd, connectedWallet, contractAddress('lunc-incinerator', connectedWallet));
  }, [lcd, connectedWallet]);
